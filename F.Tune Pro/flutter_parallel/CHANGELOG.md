...
## [0.1.1-beta] - 2026-04-22

### ✨ Cải tiến

- Thêm nút **Save** và **Export** trực tiếp trong màn hình Tune Results.
- Tune export nhanh có thể xuất ngay tune hiện tại mà không cần mở My Garage.
- Tune lưu từ kết quả giữ lại session để có thể edit lại từ Garage.

### 🛠️ Sửa lỗi

- Sửa boundary PI class: `800 = A`, `801 = S1`, `900 = S1`, `901 = S2`.
- Khôi phục crash reporter để lỗi runtime có thể hiện hộp thoại gửi log mã hóa.

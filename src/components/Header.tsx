      ...
      <div className="mx-3 mt-3 flex max-w-[1600px] items-center justify-between gap-3 rounded-2xl border border-[var(--border-1)] bg-[var(--glass-bg-modal)] px-4 py-2.5 shadow-[0_12px_40px_rgba(0,0,0,0.25)] backdrop-blur-2xl text-[var(--text-1)] sm:mx-auto">
        <div className="flex items-center gap-2.5">
          <button
            ...
            className="flex h-8.5 w-8.5 shrink-0 items-center justify-center rounded-xl bg-[var(--surface-1)] border border-[var(--border-1)] text-[var(--text-1)] transition hover:bg-[var(--surface-2)] active:scale-95"
          >
          ...
          >
            ...
            <span className="text-[16px] font-bold tracking-tight text-[var(--text-1)] drop-shadow-sm">F.VNN</span>
          </button>
        </div>
        ...
        <div className="flex items-center gap-1.5">
          <button
            ...
            className="flex h-8.5 w-8.5 shrink-0 items-center justify-center rounded-xl bg-[var(--surface-1)] border border-[var(--border-1)] text-[var(--text-1)] transition hover:bg-[var(--surface-2)] disabled:opacity-50 active:scale-95"
          >
